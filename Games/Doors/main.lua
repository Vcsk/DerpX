...
local colors = {
    ...
    Header = Color3.fromRGB(36, 48, 71),
    TextColor = Color3.fromRGB(255,255,255),
    ElementColor = Color3.fromRGB(36, 48, 71)
}
...
s5:NewLabel("Custom Entities")

s5:NewButton("Spawn Matcher","No Info", function()
